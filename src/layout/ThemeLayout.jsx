...
import AuthInfo from '../components/utilities/auth-info/AuthInfo';

import { theme } from '../components/config/theme/themeVariables';
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <FooterStyle className="bg-white dark:bg-[#1B1E2B]">
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="inline-block w-full font-medium admin-footer__copyright md:text-center text-theme-gray dark:text-white60 md:mb-[10px] mb-0">
                          © {new Date().getFullYear()} Design & Developed by{' '}
                          <a
                            href="https://demos.webinane.com"
                            target="_blank"
                      ...
                      <Col md={12} xs={24}>
                        <span className="inline-block text-right text-theme-gray dark:text-white60 md:text-center">
                          <a
                            href="https://webinane.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="hover:text-primary"
                          >
